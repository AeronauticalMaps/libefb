...
/// Vertical rate unit with m/s as SI unit.
///
/// The conventional unit for aviation vertical speed is feet per minute (fpm).
/// The SI unit is meters per second (m/s). Conversion: 1 ft/min = 0.00508 m/s.
